...
public class DownloadThread implements Runnable, DownloadFile.IDownloadProgress{
    ...
    public DownloadThread(DownloadBean bean, Context context, UpdateDialogManager updateDialogManager){
        this.bean = bean;
        this.context = context;
        this.updateDialogManager = updateDialogManager;
    }

	@Override
	public void run() {
		downloadFile = new DownloadFile(bean);
    ...
    public void downloadProgress(int progress) {
        ...
        if (null != updateDialogManager){
            updateDialogManager.changeProgress(progress);
        }
...
//        context.startService(intent);
    ...
    public void downloadFailure() {
        ...
        if(null != notification){
            notification.changeNotificationText("网络故障，文件下载失败！");
        }
