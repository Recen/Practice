...
public class SignConfigBuilder {
    ...
    public SignConfigBuilder seekBySection(boolean flag) {
        this.seekBySection = flag;
        return this;
    }
    ...
    public SignConfigBuilder sidesSectionValues(float[] sectionValues) {
        this.mSectionValueList = sectionValues;
        return this;
    }
