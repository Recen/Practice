...
public class SignSeekBar extends View {
    ...
    private float[] mSectionValueList;
    ...
    public SignSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.SignSeekBar_ssb_track_color, context.getResources().getColor(R.color.colorPrimary));
        mSecondTrackColor = a.getColor(R.styleable.SignSeekBar_ssb_second_track_color, context.getResources().getColor(R.color.colorAccent));
    ...
    private void drawMark(Canvas canvas, float xLeft, float yTop, boolean isShowTextBelowSectionMark, boolean conditionInterval) {
        ...
        for (int i = 0; i <= mSectionCount; i++) {
            ...
            if (isShowTextBelowSectionMark) {
                float m = mMin + mSectionValueList[i] * mDelta;
    ...
    void config(SignConfigBuilder builder) {
        ...
        mSectionValueList = builder.mSectionValueList;
    ...
    public SignConfigBuilder getConfigBuilder() {
        ...
        mConfigBuilder.mSectionValueList = mSectionValueList;
